{
  ...
  inputs = {
    ...
    home-manager = {
      url = "github:nix-community/home-manager/release-25.05"; # Or your desired release
      inputs = {
    ...
    forester = {
      url = "https://git.sr.ht/~stschaef/ocaml-forester";
      ref = "main";
      type = "git";
    };
        ...
        ({ pkgs, ... }: {
          ...
          environment.systemPackages = [
            ...
            (pkgs.haskell.lib.compose.overrideCabal (drv: {
              enableLibraryProfiling = true;
              enableExecutableProfiling = true;
            }) agda.packages.x86_64-linux.debug)
